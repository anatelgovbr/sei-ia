...
# preserva indicadores ordinais (º, ª) que o NFKC genérico transformaria em o/a
ORDINAL_INDICATORS = {0x00AA, 0x00BA}
...
class Normalize:
    ...
    def nfkc_seletivo(self, texto: str) -> str:  # NOSONAR
        ...
        for ch in texto:
            ...
            # 1b. indicador ordinal (º, ª)
            if code in ORDINAL_INDICATORS:
                cache[ch] = ch
                append(ch)
                continue
