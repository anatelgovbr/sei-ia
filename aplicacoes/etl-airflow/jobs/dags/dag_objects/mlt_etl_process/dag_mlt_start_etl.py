...
from jobs.db_models.sei_client import consulta_documentos, sei_client
...
FUNC_MAP = {
    "md_ia_lista_processos_indexaveis": sei_client.md_ia_lista_processos_indexaveis,
    "md_ia_consulta_processo": sei_client.md_ia_consulta_processo_metadados,
    "md_ia_lista_documentos_indexaveis": sei_client.md_ia_lista_documentos_indexaveis,
    "md_ia_consulta_documento": consulta_documentos,
}


async def _trigger_slots_async(
...
def trigger_index(
    ...
    asyncio.run(_trigger_slots_async(airflow_trigger, dag_id, valid_slots, index_list))
...
with DAG(
    ...
    check_queue_task >> trigger_index(
