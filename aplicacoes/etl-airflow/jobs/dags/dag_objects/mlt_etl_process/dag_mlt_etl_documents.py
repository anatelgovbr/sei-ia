...
from jobs.db_models.sei_client import consulta_documentos_com_conteudo, sei_client
...
with DAG(
    ...
    def extract_transform_load(**kwargs) -> None:
        ...
        df_doc_content = consulta_documentos_com_conteudo(batch_id_documents_str)
        ...
        for id_document in df_doc_content["id_protocolo_documento"].values.tolist():
            sei_client.md_ia_atualiza_documentos_indexaveis(id_documento=id_document)
