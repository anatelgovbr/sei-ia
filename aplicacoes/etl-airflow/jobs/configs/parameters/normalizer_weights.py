...
class DocumentSegmentNormalizer:
    ...
    def normalize_subsegments(self, df):
        ...
        return df_final_level_0.join(
            df.drop("segmento", axis=1), on=None, how="left", validate="many_to_many"
        )
    ...
    def _normalize_subsegments_with_pipe(self, sublevels):
        ...
        return sublevels.apply(_split_row)
...
def run():
    ...
    df_docs_weights = sei_client.md_ia_lista_segmentos_documentos_relevantes()
    ...
    df_series = sei_client.md_ia_lista_tipo_documento()
