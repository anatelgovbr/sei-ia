...
class TestBuildMltFieldsWeights(unittest.TestCase):
    ...
    @patch('jobs.configs.parameters.conf_mlt_fields_weights.get_app_db')
    def test_conf_mlt_fields_weights(self, mock_get_app_db):
        ...
        mock_get_app_db.return_value = app_db
