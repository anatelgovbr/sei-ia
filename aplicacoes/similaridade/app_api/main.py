...
@app.post("/process-recommenders/feedbacks")
async def insert_feedback_process(
    feedbacks: Annotated[list[Feedback], Body(..., example=feedback_example_process)],
) -> FeedbackResponse:
...
@app.post("/document-recommenders/feedbacks")
async def insert_feedback_document(
    feedbacks: Annotated[
        list[Feedback], Body(..., example=feedback_example_jurisprudence)
    ],
) -> FeedbackResponse:
