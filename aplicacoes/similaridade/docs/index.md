...
cd sei-ia/aplicacoes/similaridade
...
- [Repositório no GitHub](https://github.com/anatelgovbr/sei-ia/tree/main/aplicacoes/similaridade)
- [Jobs API (ETL)](https://github.com/anatelgovbr/sei-ia/tree/main/aplicacoes/etl-airflow)
