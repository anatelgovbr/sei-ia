...
SOLR_RESPONSES = [{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/mlt?q=id_protocolo:422762&fl=id_protocolo,score&mlt.maxqt=1024&mlt.fl=metadata_name_id_type_process&mlt.mintf=1&mlt.mindf=1&wt=json&mlt.interestingTerms=details&mlt.boost=true",
    "params":{},
    "payload": {"params":{}},
    "text": '{"responseHeader": {"status": 0, "QTime": 2}, "match": {"numFound": 1, "start": 0, "maxScore": 0.7002023, "numFoundExact": true, "docs": [{"id_protocolo": "422762", "score": 0.7002023}]}, "response": {"numFound": 3, "start": 0, "maxScore": 0.49104476, "numFoundExact": true, "docs": []}, "interestingTerms": ["metadata_name_id_type_process:regulamentaca", 1.0, "metadata_name_id_type_process:tecnic", 1.1844571, "metadata_name_id_type_process:condica", 1.4444346, "metadata_name_id_type_process:radiofrequenci", 1.4444346, "metadata_name_id_type_process:respectiv", 1.4444346, "metadata_name_id_type_process:faix", 1.4444346, "metadata_name_id_type_process:destinaca", 1.4444346, "metadata_name_id_type_process:servic", 1.4444346, "metadata_name_id_type_process:traz", 1.4444346, "metadata_name_id_type_process:determinad", 1.4444346, "metadata_name_id_type_process:uso", 2.8888693]}'
},
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/mlt?q=id_protocolo%3A422762&fl=id_protocolo%2Cscore&mlt.maxqt=1024&mlt.fl=metadata_name_id_type_process&mlt.mintf=1&mlt.mindf=1&wt=json&mlt.interestingTerms=details&mlt.boost=true&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
    "text": '{"responseHeader": {"status": 0, "QTime": 2}, "match": {"numFound": 1, "start": 0, "maxScore": 0.7002023, "numFoundExact": true, "docs": [{"id_protocolo": "422762", "score": 0.7002023}]}, "response": {"numFound": 3, "start": 0, "maxScore": 0.49104476, "numFoundExact": true, "docs": []}, "interestingTerms": ["metadata_name_id_type_process:regulamentaca", 1.0, "metadata_name_id_type_process:tecnic", 1.1844571, "metadata_name_id_type_process:condica", 1.4444346, "metadata_name_id_type_process:radiofrequenci", 1.4444346, "metadata_name_id_type_process:respectiv", 1.4444346, "metadata_name_id_type_process:faix", 1.4444346, "metadata_name_id_type_process:destinaca", 1.4444346, "metadata_name_id_type_process:servic", 1.4444346, "metadata_name_id_type_process:traz", 1.4444346, "metadata_name_id_type_process:determinad", 1.4444346, "metadata_name_id_type_process:uso", 2.8888693]}'
},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=metadata_name_id_type_doc_7%3A%2A&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=%2A%3A%2A&fl=sumtotaltermfreq%28metadata_name_id_type_doc_7%29&start=0&rows=1",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=metadata_name_id_type_doc_8%3A%2A&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=%2A%3A%2A&fl=sumtotaltermfreq%28metadata_name_id_type_doc_8%29&start=0&rows=1",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=metadata_name_id_type_doc_11%3A%2A&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=%2A%3A%2A&fl=sumtotaltermfreq%28metadata_name_id_type_doc_11%29&start=0&rows=1",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=metadata_name_id_type_doc_16%3A%2A&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url": "http://fakehost:0000/solr/process/select?q=%2A%3A%2A&fl=sumtotaltermfreq%28metadata_name_id_type_doc_16%29&start=0&rows=1",
    "params":{},
    "payload": {"params":{}},
...
},
{
    ...
    "params": {"q": f"id_document:111111", "debugQuery": "on", "wt": "json", "mlt.interestingTerms": "details", "rows": 0, "fl": "id_document,score,id_type_document", "mlt.mindf": 1, "mlt.mintf": 1},
    "payload": {"params":{}},
...
},
{
    "status_code":200,
    "url":"http://fakehost:0000/solr/documentos_bm25/mlt",
    "params":{'q': 'id_document:3256530', 'debugQuery': 'on', 'wt': 'json', 'mlt.interestingTerms': 'details', 'rows': 0, 'fl': 'id_document,score,id_type_document', 'mlt.mindf': 1, 'mlt.mintf': 1},
    "payload": {"params":{}},
...
},
{
    "status_code":200,
    "url":"http://fakehost:0000/solr/documentos_bm25/mlt",
    "params": {'q': 'id_document:1596887', 'debugQuery': 'on', 'wt': 'json', 'mlt.interestingTerms': 'details', 'rows': 0, 'fl': 'id_document,score,id_type_document', 'mlt.mindf': 1, 'mlt.mintf': 1},
    "payload": {"params":{}},
...
},
{
    "status_code":200,
    "url":"http://fakehost:0000/solr/documentos_bm25/mlt",
    "params": {'q': 'id_document:1234567', 'debugQuery': 'on', 'wt': 'json', 'mlt.interestingTerms': 'details', 'rows': 0, 'fl': 'id_document,score,id_type_document', 'mlt.mindf': 1, 'mlt.mintf': 1},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url":"http://fakehost:0000/solr/documentos_bm25/select?q=content%3A%2A&start=0&rows=0",
    "params":{},
    "payload": {"params":{}},
...
{
    "status_code":200,
    "url":"http://fakehost:0000/solr/documentos_bm25/select?q=%2A%3A%2A&fl=sumtotaltermfreq%28content%29&start=0&rows=1",
    "params":{},
    "payload": {"params":{}},
...
def compare_params(params1,params2):
    for k in params2.keys():
        if k == "q":
            ...
            cond = (str(params1.get(k)) == str(params2[k]))
        if not cond:
            return False
    return True


def mock_requests_post(url, json, timeout, **kwargs):  # noqa: ARG001
...
def mock_requests_get(url,**kwargs):
    ...
    exact_matches = [obj for obj in SOLR_RESPONSES if obj["url"] == url]
    if exact_matches:
        return MockResponse(exact_matches[0]["text"], exact_matches[0]["status_code"])

    # SolrRequests.get() embute start/rows/params direto na querystring da URL
    # (nao usa mais o kwarg params= do requests.get), entao registros do fixture
    # com "params" preenchido so casam via comparacao de querystring, ignorando
    # extras como start/rows que nao estejam explicitados no fixture.
    parsed = urlparse(url)
    base_url = f"{parsed.scheme}://{parsed.netloc}{parsed.path}"
    query_params = {k: v[0] for k, v in parse_qs(parsed.query).items()}
    fuzzy_matches = [
        obj for obj in SOLR_RESPONSES
        if obj["url"] == base_url and obj["params"] and compare_params(query_params, obj["params"])
    ]
    if fuzzy_matches:
        return MockResponse(fuzzy_matches[0]["text"], fuzzy_matches[0]["status_code"])
