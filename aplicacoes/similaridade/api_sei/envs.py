...
if USE_AUTHENTICATION and not SECRET_KEY:
    raise RuntimeError("SECRET_KEY é obrigatória quando USE_AUTHENTICATION=true")

ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", "5"))

# Endereço interno sem TLS na rede docker do stack (mesmo padrão de LITELLM_PROXY_URL).
_JOBS_API_DEFAULT = "http://etl-airflow-api:8642"  # NOSONAR
JOBS_API_ADDRESS = os.getenv("JOBS_API_ADDRESS", _JOBS_API_DEFAULT)
...
SOLR_READ_TIMEOUT_SECONDS = int(os.getenv("SOLR_READ_TIMEOUT_SECONDS", "30"))
