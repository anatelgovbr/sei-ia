...
_FL_DOCUMENT_FIELDS = "id_document,score,id_type_document"
...
class SolrJurisprudence:
    ...
    def __normalize_values(
        self, data_docs, max_score: float | None = None
    ) -> list[dict]:
        """
    ...
    def get_jurisprudence_1doc(self, id_doc: int, rows: int, fq: str) -> list[dict]:
        ...
        try:
            ...
            logger.exception("Erro em get_jurisprudence_1doc para id_doc=%s", id_doc)
            raise
