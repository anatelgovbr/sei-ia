...
@router.get(
    ...
    response_description="Return HTTP Status Code 200 (OK)",
    responses={503: {"description": "Solr unavailable"}},
)
def get_health_solr(core_name: Annotated[str | None, Query()] = None) -> HealthCheck:
...
@router.get(
    ...
    response_description="Return HTTP Status Code 200 (OK)",
    responses={503: {"description": "Process recommendation service unavailable"}},
)
...
@router.get(
    ...
    response_description="Return HTTP Status Code 200 (OK)",
    responses={503: {"description": "Document recommendation service unavailable"}},
)
