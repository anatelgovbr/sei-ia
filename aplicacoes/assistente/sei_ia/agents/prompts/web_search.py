...
- Quando um dado vier anotado com (fonte: <web_N>), REPRODUZA EXATAMENTE esse
  marcador <web_N> ao afirmar o dado — ele identifica a fonte específica daquele
  dado (não invente nem renumere; copie o marcador como está).
