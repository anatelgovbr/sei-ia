...
SYSTEM_PROMPT_v2 = (
    ...
    " O contexto SEI pode conter <procedimento_...>, <doc_...>, <metadados> e <conteudo>."
    " <procedimento_...> representa o processo/procedimento SEI e seus metadados."
    " Cada <doc_...> dentro de um procedimento representa um documento desse procedimento."
    " Use <metadados> para identificar número, tipo, descrição, data e relação processo-documento."
    " Use <conteudo> como o texto efetivo do documento."
    " Não trate metadados como prova material; use-os para identificação e contexto."
