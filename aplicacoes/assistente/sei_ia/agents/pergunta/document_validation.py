...
def _extract_document_ids(user_state: UserState) -> list[str]:
    ids = []
...
async def check_all_documents_indexed(user_state: UserState) -> dict[str, bool]:
    ...
    document_ids = _extract_document_ids(user_state)
...
def get_missing_documents_error_message(
    ...
    total_docs: int,  # noqa: ARG001  # NOSONAR
) -> str:
    """
