...
def _build_summarize_graph(llm: BaseChatModel, max_ctx_tokens: int) -> Runnable:  # noqa: C901  # NOSONAR
    ...
    def collapse_summaries(state: SummaryOverallState) -> SummaryOverallState:
        ...
        for group in baskets:
            ...
            results.append(Document(page_content=llm.invoke(prompt).content))
