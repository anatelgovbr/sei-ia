...
async def similarity_query(  # noqa: C901, PLR0912, PLR0915  # NOSONAR
    prompt_embedding: list,
    filter_metadata: list[dict],
    min_similarity: float,
    top_k: int,
    user_state: dict = None,  # noqa: RUF013
) -> tuple[str, dict]:
    ...
    logger.debug(f"Condições de filtro SQL: {filter_conditions or '1=1'}")
