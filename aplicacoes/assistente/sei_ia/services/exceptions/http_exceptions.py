...
class HTTPException204(HTTPException):
    ...
    def __init__(
        self,
        status_code: int = 204,
        detail: str = "Documento sem conteudo",
        ...
        Args:
            ...
            formatted_document_number (str | None, optional): Número visível do
                documento preservado para consumidores internos. Defaults to None.

        Returns:
            None
        """
        self.formatted_document_number = formatted_document_number
...
class HTTPException411DocumentTimeout(HTTPException):
    ...
    def __init__(
        self, document_id: str, status_code: int = 411, detail: str | None = None
    ) -> None:
        """Initializes the class with the given status code and detail message.
...
class HTTPException412SeiApiTimeout(HTTPException):
    ...
    def __init__(
        self, document_id: str, status_code: int = 412, detail: str | None = None
    ) -> None:
        """Initializes the class with the given status code and detail message.
