...
class ModelResponse:
    ...
    def __init__(
        ...
        self.created = datetime.now()  # noqa: DTZ005, RUF100
        self.n_tokens = {
    ...
    def to_dict(self) -> dict:
        ...
        """
        configs_model_used = get_model_config(
            agent_tag=self.user_state["agent_tag"],
            model_override=self.user_state.get("model_override"),
        )
        return {
