...
**Função**: Executa busca web pela stack SearXNG (opcional)

**Arquivos**: `sei_ia/agents/websearch/searx_crawl_tool.py`,
`web_research_agent.py` e `deep_research_agent.py`

O agente consulta o SearXNG, coleta páginas com fastCRW e usa Byparr como fallback.
No `session_stream`, `ASSISTENTE_SESSION_WEB_TOOL` escolhe o fluxo raso ou profundo.
