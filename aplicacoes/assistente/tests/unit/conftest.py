...
Esta versão usa sys.modules com salvamento e restauração do estado original
para manter os testes isolados.
"""
...
def mock_similarity_query():
    ...
    with patch("sei_ia.agents.rag.similarity.similarity_query") as mock:
        ...
        async def async_return(*args, **kwargs):  # noqa: ARG001
