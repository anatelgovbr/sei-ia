...
class TestExtractRelevantChunks:
    ...
    #     user_state = create_mock_user_state_direct_path()  # noqa: ERA001
    #     # Criar chunks muito grandes que excedem o limite
    #     # Usar 50000 palavras para garantir que excedem o limite de contexto
    #     large_chunk = "palavra " * 20000  # ~400k caracteres por chunk  # noqa: ERA001
    #     document_chunks = [
    #         (large_chunk, 0.95),  # noqa: ERA001
    #         (large_chunk, 0.85),  # noqa: ERA001
    #         (large_chunk, 0.75)  # noqa: ERA001
    #     ]

    #     result = extract_relevant_chunks(user_state, document_chunks)  # noqa: ERA001

    #     assert isinstance(result, str)  # noqa: ERA001
    ...
    #     total_chunks_size = len(large_chunk) * 3  # noqa: ERA001
    #     assert len(result) < total_chunks_size * 0.5, f"Resultado muito grande ({len(result)} tokens): {result}" # Menos de 50% do total  # noqa: ERA001
