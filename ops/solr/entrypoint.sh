...
: "${SOLR_USER:?SOLR_USER is required}"
...
export SOLR_SSL_KEY_STORE_PASSWORD="${SOLR_PASSWORD}"
export SOLR_SSL_TRUST_STORE=/var/solr-ssl/keystore.p12
export SOLR_SSL_TRUST_STORE_PASSWORD="${SOLR_PASSWORD}"
...
mkdir -p /var/solr/configsets
cp -a /opt/seiia/solr-configsets/. /var/solr/configsets/
chown -R solr:solr /var/solr/data
chown -R solr:solr /var/solr/configsets
