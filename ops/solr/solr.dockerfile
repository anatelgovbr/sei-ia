...
# O volume persistente monta /var/solr em runtime. Preserve os configsets na
# imagem e deixe o entrypoint sincroniza-los para o volume antes de iniciar.
COPY aplicacoes/etl-airflow/jobs/configs/solr_core_configs/configsets /opt/seiia/solr-configsets
